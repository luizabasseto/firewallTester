...
def create_about_tab(self):
    ...
    self.notebook.addTab(self.about_frame, QIcon("assets/do-utilizador.png"), "About")
    ...
    lbl_description = QLabel(description, width=100)
    ...
    btn_help.clicked.connect(self.open_github_project)
